...
def gen():
    ...
    while count != 8888: # size of collection, so script stops
        ...
        """       
        if armors == '01_Armor_Example1.png':
            eyes = '00_Eyes_None.png'
        if overheads == '07_Overhead_Example_2.png':
            eyes = '00_Eyes_None.png'
            mouth = '00_Mouth_None.png'

        traits.extend((bgs, skins, armors, chains, mouths, eyez, overheads)) # putting all traits for this NFT in a list (make sure to choose your order of layering by this list from left to right)
